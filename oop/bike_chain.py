# Bike Chaining Object Class Exercise
#
class Bike():
...
Bike_A.ride().ride().ride().reverse().displayinfo()

print "Starting Bike B"
Bike_B.ride().ride().reverse().reverse().displayinfo()

print "Starting Bike C"
Bike_C.reverse().reverse().reverse().displayinfo()
